...
// Fetch order details
$query = $conn->prepare("SELECT o.Order_Id, o.Total_Price, o.Payment_Code, t.Source, t.Destination, t.Price as Trip_Price
                         FROM Orders o
                         JOIN Trips t ON o.Trip_Id = t.Trip_Id
                         WHERE o.Order_Id = ?");
$query->bind_param("i", $order_id);
$query->execute();
$query->bind_result($order_id, $total_price, $payment_code, $source, $destination, $trip_price);
$query->fetch();
$query->close();
$conn->close();
